...
const StackCard = (props) => {
  return (
    <div className="flex flex-col lg:mr-10 lg:w-[28%] my-4 lg:my-10 border p-8 drop-shadow-xl border-slate-600 hover:bg-teal-900/40 hover:scale-105 cursor-pointer transition-all duration-300 ease-out rounded-lg">
