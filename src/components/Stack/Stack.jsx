  ...
  return (
    <section className='my-32'>
      ...
      <div className='flex flex-col lg:flex-row flex-wrap mt-10'>
        <StackCard name="Languages" tech={["Java", "JavaScript", "SQL"]}/>
        <StackCard name="Frameworks / Libraries" tech={["SpringBoot","Kafka","React.js", "Tailwind CSS"]}/>
        <StackCard name="Tools" tech={["Git", "VSCode", "Intellij IDEA", "Postman", "Docker", "Linux Terminal"]}/>
