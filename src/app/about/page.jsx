  ...
  return (
    <section className='mt-28'>
      ...
      <div className='bg-teal-800 p-5 tracking-wider flex flex-col gap-4 my-20'>
        ...
        <a href='https://indigo-ring-f16.notion.site/Sujal-Samai-b6d2c9e8d513441b9c0cc863d69d3705?pvs=4' className='w-fit flex items-center gap-1 bg-stone-950 py-2 px-5 rounded-lg hover:text-teal-400 transition-colors duration-300'>View Resume <span className='animate-pulse'><BsArrowUpRight/></span></a>
      </div>
      <Stack/>
      <hr/>
