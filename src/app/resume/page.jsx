  ...
  return (
    <>
      ...
      <aside className="flex md:hidden flex-col content-center justify-center gap-3 md:gap-5 w-11/12 mx-auto">
            ...
            <Link href="https://indigo-ring-f16.notion.site/Sujal-Samai-b6d2c9e8d513441b9c0cc863d69d3705?pvs=4" className="flex items-center justify-center gap-1 bg-stone-950 py-2 px-5  border border-teal-400 rounded-lg hover:text-teal-400 transition-colors duration-300">Notion Resume <span className='animate-pulse'><BsArrowUpRight/></span></Link>
          </aside>
    </>
  )
}
