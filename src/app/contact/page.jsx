  ...
  return (
    <section>
      <div className='lg:w-7/12 mb-32 mt-20'>
        ...
        <h6 className='text-2xl lg:text-3xl'>Thanks for checking out the Portfolio. If you would like to contact me in the future or want to hire me, below is the way.</h6>
      </div>
